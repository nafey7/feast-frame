...
export function RestaurantCard({
  ...
  if (viewMode === "list") {
    return (
      <Link href={`/restaurants/${restaurant.id}`}>
        <div className="group bg-white dark:bg-gray-900 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 dark:border-gray-800 animate-fade-in h-60 cursor-pointer">
  ...
  return (
    <Link href={`/restaurants/${restaurant.id}`}>
      <div className="group bg-white dark:bg-gray-900 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-100 dark:border-gray-800 animate-fade-in cursor-pointer">
        {/* Image Section */}
