...
import { filterOptions } from "@/data/mock-restaurants";
...
export default function RestaurantsPage() {
  ...
  const activeFilterCount =
    filters.cuisines.length + (filters.minRating !== null ? 1 : 0);
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-8 animate-slide-up">
            ...
            <p className="text-xl text-foreground/70 max-w-2xl mx-auto">
              Browse through {restaurants.length} restaurants and thousands
              of dish photos
            </p>
          </div>
          ...
          {loading && (
            <div className="flex items-center justify-center py-20">
              <div className="text-center">
                ...
                <p className="text-xl text-foreground/70">Loading restaurants...</p>
              </div>
            </div>
          )}
